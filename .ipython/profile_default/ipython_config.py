...
# c.InteractiveShell.banner1 = 'Python 3.4.2 (default, Jul  9 2015, 17:24:30) \nType "copyright", "credits" or "license" for more information.\n\nIPython 5.0.0 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
...
# The name of a Pygments style to use for syntax highlighting:  borland,
# paraiso-light, monokai, trac, colorful, emacs, autumn, xcode, friendly,
# default, lovelace, vim, paraiso-dark, perldoc, fruity, bw, murphy, igor,
# tango, manni, rrt, native, algol, pastie, algol_nu, vs
